...
export default function (input: string[], { logger }: Context) {
    ...
    for (const line of lines) {
        ...
        const all = [...line[0], ...line[1]].map((e) => e.split(""));
        ...
        map["tr"].push(...one);
        map["br"].push(...one);
        map["m"].push(...four.filter((e) => !one.includes(e)));

        map["tl"].push(...four.filter((e) => !one.includes(e)));

        map["t"].push(...seven.find((e) => !one.includes(e)));
        ...
        const dict = {
            [[map["t"][0], map["tr"][0], map["br"][0], map["b"][0], map["tl"][0], map["bl"][0]]
                .sort()
                .join("")]: 0,
            [[map["tr"][0], map["br"][0]].sort().join("")]: 1,
            [[map["t"][0], map["tr"][0], map["m"][0], map["bl"][0], map["b"][0]].sort().join("")]:
                2,
            [[map["t"][0], map["tr"][0], map["m"][0], map["br"][0], map["b"][0]].sort().join("")]:
                3,
            [[map["tr"][0], map["tl"][0], map["m"][0], map["br"][0]].sort().join("")]: 4,
            [[map["t"][0], map["tl"][0], map["m"][0], map["br"][0], map["b"][0]].sort().join("")]:
                5,
            [[map["t"][0], map["tl"][0], map["m"][0], map["br"][0], map["bl"][0], map["b"][0]]
                .sort()
                .join("")]: 6,
            [[map["tr"][0], map["br"][0], map["t"][0]].sort().join("")]: 7,
            [[
                map["t"][0],
                map["tr"][0],
                map["br"][0],
                ...
                .sort()
                .join("")]: 8,
            [[map["t"][0], map["tr"][0], map["br"][0], map["m"][0], map["b"][0], map["tl"][0]]
                .sort()
                .join("")]: 9,
        };
        ...
        for (const on of line[1]) {
            output += dict[on.split("").sort().join("")];
        }
